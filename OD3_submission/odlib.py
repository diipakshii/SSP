...
def orbitalelements():
    ...
    # Time Dependent Orbital Elements (OD3)

    # Mean Anomaly - M

    E = math.acos((1/e) * (1 - r/a))
    ...
    M_rad = E - (e * math.sin(E_act))
    M_deg = math.degrees(M_rad)

    error_M = (abs(act_M - M_deg) / act_M) * 100
    
    # Time of Last Perihelion passage
    ...
    print("Mean Anomaly", act_M, M_deg, error_M)
